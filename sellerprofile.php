            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
					<li><a href="sellerprofile.php">Profile</a></li>
          					<li><a href="changepassseller.php">Change Password</a></li>
    ...
    <div class="container">
      ...
      <?php  session_start();
        ...
        if(isset($_SESSION['seller']))
        {
              ...
              $sql="select * from tb_seller where s_email='$email'";
      ...
      ?>
        ...
        <div class="row main-low-margin ">
            ...
            <div class="col-md-6 col-sm-6">
                <form action="updateseller.php" method="post" id="signupform">
                    ...
                    <div class="row form-group name">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input type="textarea" name="address" id="txtaddress" value="<?php echo $add; ?>" class="form-control" placeholder="Address" tabindex="5" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group name">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input type="email" name="email" id="txtemail" value="<?php echo $email; ?>" class="form-control" placeholder="Email" tabindex="5" autocomplete="off" required disabled="disabled">
                        </div>
                    </div>
                    <div class="row form-group name">
                        <div class="col-md-4 col-sm-4">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input type="date" name="dob" id="txtDOB" value="<?php echo $dob;?>" class="form-control" placeholder="lastname" tabindex="5" autocomplete="off" disabled="disabled">
                        </div>
                    </div>
                    <div class="row">
